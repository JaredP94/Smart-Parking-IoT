...
\headerbox{System Design}{name=sysdesign1,column=0,below=objectives,bottomaligned=bottom}{ 
	\textbf{Features}\\
	\textbf{Hardware}\\
	\textbf{Software}\\ (mesh network flow diagram)
}

\headerbox{System Design (cont.)}{name=sysdesign2,column=1,span=2,row=0,span=2}{ 
	\begin{multicols}{2}
	\end{multicols}
}


\headerbox{Deployment \& Evaluation}{name=deployandeval,column=1,row=1,span=2,below=sysdesign2}{
	\begin{multicols}{2}
	\end{multicols}
}


\headerbox{Future Work}{name=futurework,column=3,row=0,span=1}{
		\begin{itemize}[leftmargin=13pt]\compresslist
...
\headerbox{Conclusions}{name=conclusion,column=3,span=1,row=2,below=futurework}{
