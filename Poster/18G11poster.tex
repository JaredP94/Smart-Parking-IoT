...
\headerbox{System Design (cont.)}{name=sysdesign2,column=1,span=2,row=0,bottomaligned=bottom}{ 
	\begin{multicols}{2}
		...
		\begin{center}
			\includegraphics[width=0.9\columnwidth]{lifetime_vs_consumption}
			\captionof{figure}{Figure caption}
		\end{center}
...
\headerbox{Deployment \& Evaluation}{name=deployandeval,column=3,row=0,span=1}{
	%\begin{multicols}{2}
		
		\begin{center}
			\includegraphics[width=0.6\columnwidth]{app_screenshot}
			\captionof{figure}{Figure caption}
		\end{center}
	%\end{multicols}
